...
const GuessGroup: React.FunctionComponent<GuessGroupProps> = (
    ...
    return (
        <div className={styles.guessGroup}>
            <Guess guess={props.guesses[0]} status={getStatus(0)} />
            <Guess guess={props.guesses[1]} status={getStatus(1)} />
            <Guess guess={props.guesses[2]} status={getStatus(2)} />
            <Guess guess={props.guesses[3]} status={getStatus(3)} />
            <Guess guess={props.guesses[4]} status={getStatus(4)} />
        </div>
    );
};
